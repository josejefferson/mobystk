  ...
  return function (t) {
    ...
    t.exports = function (t, e) {
      var r,
          ...
          d = t.global,
          g = t.stat;
      if (r = d ? n : g ? n[v] || c(v, {}) : (n[v] || {}).prototype) for (l in e) {
        if (p = e[l], f = t.noTargetGet ? (h = o(r, l)) && h.value : r[l], !s(d ? l : v + (g ? "." : "#") + l, t.forced) && void 0 !== f) {
    ...
    (t.exports = function (t, e, r, c) {
      var u,
          ...
          p = !!c && !!c.enumerable,
          h = !!c && !!c.noTargetGet;
      "function" == typeof r && ("string" != typeof e || i(r, "name") || o(r, "name", e), (u = l(r)).source || (u.source = f.join("string" == typeof e ? e : ""))), t !== n ? (s ? !h && t[e] && (p = !0) : delete t[e], p ? t[e] = r : o(t, e, r)) : p ? t[e] = r : a(e, r);
    ...
    var n = r(77),
      ...
      return function (v, d, g, y) {
        for (var b, m, x = i(v), w = o(x), S = n(d, g, 3), _ = a(w.length), O = 0, A = y || c, E = e ? A(v, _) : r || p ? A(v, 0) : void 0; _ > O; O++) if ((h || O in w) && (m = S(b = w[O], O, x), t)) if (e) E[O] = m;else if (m) switch (t) {
          case 3:
            return !0;
    ...
    var n,
      ...
      v = n ? function (t) {
        ...
        return t = null, e;
      }(n) : ((e = s("iframe")).style.display = "none", u.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write(h("document.F=Object")), t.close(), t.F);
    ...
    c[f] = !0, t.exports = Object.create || function (t, e) {
      var r;
      return null !== t ? (p.prototype = o(t), r = new p(), p.prototype = null, r[f] = t) : r = v(), void 0 === e ? r : i(r, e);
    };
  }, function (t, e, r) {
    var n = r(73),
        o = r(50);
    ...
    if (i("Number", !y(" 0o1") || !y("0b1") || y("+0x1"))) {
      ...
      }, _ = n ? h(y) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), O = 0; _.length > O; O++) c(y, w = _[O]) && !c(S, w) && d(S, w, v(y, w));
    ...
    (l || p || f) && (s = function (t) {
      var e,
          ...
          d = 0,
          g = t;
      return s && (-1 === (h = h.replace("y", "")).indexOf("g") && (h += "g"), g = String(t).slice(a.lastIndex), a.lastIndex > 0 && (!a.multiline || a.multiline && "\n" !== t[a.lastIndex - 1]) && (v = "(?: " + v + ")", g = " " + g, d++), r = new RegExp("^(?:" + v + ")", h)), p && (r = new RegExp("^" + v + "$(?!\\s)", h)), l && (e = a.lastIndex), n = c.call(s ? r : a, g), s ? n ? (n.input = n.input.slice(d), n[0] = n[0].slice(d), n.index = a.lastIndex, a.lastIndex += n[0].length) : a.lastIndex = 0 : l && n && (a.lastIndex = a.global ? n.index + n[0].length : e), p && n && n.length > 1 && u.call(n[0], r, function () {
    ...
    t.exports = function (t, e, r, f) {
      ...
      if (!d || !g || "replace" === t && (!s || !l || p) || "split" === t && !h) {
        var y = /./[v],
          ...
          REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: p
            ...
            m = b[0],
            x = b[1];
        n(String.prototype, t, m), n(RegExp.prototype, v, 2 == e ? function (t, e) {
    ...
    n("split", 2, function (t, e, r) {
      ...
      return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, r) {
        ...
        for (var c, u, s, l = [], p = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), v = 0, d = new RegExp(t.source, p + "g"); (c = f.call(d, n)) && !((u = d.lastIndex) > v && (l.push(n.slice(v, c.index)), c.length > 1 && c.index < n.length && h.apply(l, c.slice(1)), s = c[0].length, v = u, l.length >= i));) d.lastIndex === c.index && d.lastIndex++;

        return v === n.length ? !s && d.test("") || l.push("") : l.push(n.slice(v)), l.length > i ? l.slice(0, i) : l;
        ...
        for (var x = 0, w = 0, S = []; w < p.length;) {
          ...
          if (null === O || (_ = v(s(b.lastIndex + (d ? 0 : w)), p.length)) === x) w = u(p, w, g);else {
    ...
    var n = r(0),
      ...
      t === G && at(J, e, r), v(t);
      var n = y(e, !0);
      return v(r), f(q, n) ? (r.enumerable ? (f(t, B) && t[B][n] && (t[B][n] = !1), r = m(r, {
        enumerable: b(0, !1)
    ...
    (u || (C((V = function () {
      ...
      return ot(R(t), t);
    }), E.f = ut, A.f = at, O.f = st, w.f = S.f = lt, _.f = ft, L.f = function (t) {
      return ot(T(t), t);
    ...
    t.exports = function (t, e, r, l, h, b, m) {
      ...
      if (P && (x = i(P.call(new t())), v !== Object.prototype && x.next && (f || i(x) === v || (a ? a(x, v) : "function" != typeof x[g] && u(x, g, y)), c(x, O, !0, !0), f && (p[O] = y))), "values" == h && j && "values" !== j.name && (A = !0, C = function () {
        return j.call(this);
      }), f && !m || E[g] === C || u(E, g, C), p[e] = C, h) if (w = {
        values: _("values"),
        keys: b ? C : _("keys"),
        entries: _("entries")
      }, m) for (S in w) (d || A || !(S in E)) && s(E, S, w[S]);else n({
        target: e,
        proto: !0,
        forced: d || A
      }, w);
    ...
    n("match", 1, function (t, e, r) {
      return [function (e) {
        ...
        for (var f, p = [], h = 0; null !== (f = u(a, s));) {
          var v = String(f[0]);
          p[h] = v, "" === v && (a.lastIndex = c(s, i(a.lastIndex), l)), h++;
        }
    ...
    n({
      ...
      splice: function (t, e) {
        var r,
            ...
            b = o(t, y),
            m = arguments.length;
        if (0 === m ? r = n = 0 : 1 === m ? (r = 0, n = y - b) : (r = m - 2, n = d(v(i(e), 0), y - b)), y + r - n > 9007199254740991) throw TypeError("Maximum allowed length exceeded");

        for (l = u(g, n), f = 0; f < n; f++) (p = b + f) in g && s(l, f, g[p]);

        if (l.length = n, r < n) {
          for (f = b; f < y - n; f++) h = f + r, (p = f + n) in g ? g[h] = g[p] : delete g[h];

          for (f = y; f > y - n + r; f--) delete g[f - 1];
        } else if (r > n) for (f = y - n; f > b; f--) h = f + r - 1, (p = f + n - 1) in g ? g[h] = g[p] : delete g[h];
    ...
    t.exports = !l || o(function () {
      ...
      for (var r = u(t), o = arguments.length, l = 1, f = a.f, p = c.f; o > l;) for (var h, v = s(arguments[l++]), d = f ? i(v).concat(f(v)) : i(v), g = d.length, y = 0; g > y;) h = d[y++], n && !p.call(v, h) || (r[h] = v[h]);
    ...
    for (var f in o) {
      ...
      if (h) {
        ...
        if (h[s] || a(h, s, f), o[f]) for (var v in i) if (h[v] !== i[v]) try {
          a(h, v, i[v]);
        } catch (t) {
          h[v] = i[v];
        }
    ...
    t.exports = function (t) {
      var e,
          ...
          m = s(v),
          x = 0;
      if (b && (y = n(y, g > 2 ? arguments[2] : void 0, 2)), null == m || d == Array && a(m)) for (r = new d(e = c(v.length)); e > x; x++) h = b ? y(v[x], x) : v[x], u(r, x, h);else for (p = (f = m.call(v)).next, r = new d(); !(l = p.call(f)).done; x++) h = b ? i(f, y, [l.value, x], !0) : l.value, u(r, x, h);
      return r.length = x, r;
    };
  }, function (t, e, r) {
    var n = r(4),
    ...
    n({
      ...
      slice: function (t, e) {
        var r,
            ...
            h = a(t, p),
            v = a(void 0 === e ? p : e, p);
        if (i(f) && ("function" != typeof (r = f.constructor) || r !== Array && !i(r.prototype) ? o(r) && null === (r = r[d]) && (r = void 0) : r = void 0, r === Array || void 0 === r)) return g.call(f, h, v);

        for (n = new (void 0 === r ? Array : r)(y(v - h, 0)), l = 0; h < v; h++, l++) h in f && s(n, l, f[h]);
    ...
    n("replace", 2, function (t, e, r, n) {
      ...
      return [function (r, n) {
        ...
        for (var _, O = "", A = 0, E = 0; E < w.length; E++) {
          ...
          for (var j = String(S[0]), C = f(p(c(S.index), h.length), 0), P = [], k = 1; k < S.length; k++) P.push(void 0 === (_ = S[k]) ? _ : String(_));
    ...
    var n = r(7),
      ...
      return function (e, r, c) {
        var u,
            ...
            p = void 0 === c ? " " : String(c),
            h = n(r);
        return h <= f || "" == p ? l : (u = h - f, (s = o.call(p, a(u / p.length))).length > u && (s = s.slice(0, u)), t ? l + s : s + l);
      };
    };
    ...
    n({
      ...
      toFixed: function (t) {
        ...
        if (u < 0 && (h = "-", u = -u), u > 1e-21) if (r = (e = function (t) {
        ...
        return v = f > 0 ? h + ((c = v.length) <= f ? "0." + a.call("0", f - c) + v : v.slice(0, c - f) + "." + v.slice(c - f)) : h + v;
      }
    });
  }, function (t, e, r) {
    var n = r(15);
    ...
    r(67), r(56), r(79), r(80), r(59), r(108), r(109), r(82), r(113), r(114), r(37), r(38), r(89), r(90), r(39), r(40), r(28), r(42), r(93), r(119), r(95), r(65), r(122), r(123), r(130), r(133), r(134), r(135), r(136), r(66), r(138);
    ...
    function s(t, e, r, n) {
      ...
      for (var a, u = c(e); !(a = u()).done;) for (var s, l = a.value, f = c(r); !(s = f()).done;) {
        var p = s.value;
        l[t](p, n, i({
          capture: !1
        }, o));
        ...
        switch (o) {
          ...
          case "rgba":
            var f = n(e),
                ...
                v = f[5],
                d = f[6];
            if (p > 255 || h > 255 || v > 255 || d < 0 || d > 1 || !i(d)) break t;
            return {
              values: [].concat(A(p, h, v), [d]),
              a: d,
              type: o
            };
          ...
          case "hsla":
            var m = n(e),
                ...
                S = m[5],
                _ = m[6];
            if (x > 360 || w > 100 || S > 100 || _ < 0 || _ > 1 || !i(_)) break t;
            return {
              values: [].concat(j(x, w, S), [_]),
              a: _,
              type: o
            };
          ...
          case "hsva":
            var O = n(e),
                ...
                I = O[5],
                R = O[6];
            if (P > 360 || k > 100 || I > 100 || R < 0 || R > 1 || !i(R)) break t;
            return {
              values: [P, k, I, R],
              a: R,
              type: o
      ...
      var e = {
        ...
        _keyboard: function (t) {
          ...
          if (document.activeElement === r.wrapper) {
            ...
            if ("keydown" === n && (a || c || u || s)) {
              var l = 0,
                  f = 0;
              "v" === i ? l = a || c ? 1 : -1 : "h" === i ? l = a || c ? -1 : 1 : (f = a ? -1 : u ? 1 : 0, l = s ? -1 : c ? 1 : 0), e.update(I(e.cache.x + .01 * l), I(e.cache.y + .01 * f)), t.preventDefault();
        ...
        destroy: function () {
          var t = e.options,
              r = e._tapstart,
              n = e._keyboard;
          f(document, ["keydown", "keyup"], n), f([t.wrapper, t.element], "mousedown", r), f([t.wrapper, t.element], "touchstart", r, {
            passive: !1
          });
        }
      },
          ...
          n = e._tapstart,
          o = e._keyboard;
      return l([r.wrapper, r.element], "mousedown", n), l([r.wrapper, r.element], "touchstart", n, {
        passive: !1
      }), l(document, ["keydown", "keyup"], o), e;
    }
    ...
    var B = {
      ...
      for (var p, h = t.getBoundingClientRect(), v = e.getBoundingClientRect(), d = {
        t: h.top - v.height - i,
        b: h.bottom + i,
        r: h.right + i,
        l: h.left - v.width - i
      ...
      }, y = a.split("-"), b = y[0], m = y[1], x = void 0 === m ? "middle" : m, w = u[b], S = c[x], _ = o.top, O = o.left, A = o.bottom, E = o.right, j = L(w); !(p = j()).done;) {
        var C = p.value,
            P = "t" === C || "b" === C,
            k = d[C],
            ...
            H = P ? [_, O] : [O, _],
            $ = H[1];
        if (!(k < H[0] || k + N[0] > F[0])) for (var G, V = L(S); !(G = V()).done;) {
          var W = G.value,
              z = g[(P ? "v" : "h") + W];
          if (!(z < $ || z + M > U)) return e.style[T] = z - v[T] + "px", e.style[R] = k - v[R] + "px", C + W;
        }
      }
    ...
    var W = function () {
      function t(e) {
        ...
        var l = i.preview,
            ...
            p = i.hue,
            h = i.palette;
        i.opacity = !u && f, i.palette = h || l || f || p, this._preBuild(), this._buildComponents(), this._bindEvents(), this._finalBuild(), o && o.length && o.forEach(function (t) {
        ...
        this._nanopop = (d = x, g = {
          margin: s
        }, y = "object" != typeof (v = m) || v instanceof HTMLElement ? D({
          reference: v,
          popper: d
        }, g) : v, {
          update: function () {
        ...
        this._setupAnimationFrame = requestAnimationFrame(function t() {
          ...
          w.setColor(e.default), w._rePositioningPicker(), e.defaultRepresentation && (w._representation = e.defaultRepresentation, w.setColorRepresentation(w._representation)), e.showAlways && w.show(), w._initializingActive = !1, w._emit("init");
        });
      }

      var e = t.prototype;
      return e._preBuild = function () {
        for (var t, e, r, n, o, i, a, c, u, s, l, f, p = this.options, v = 0, g = ["el", "container"]; v < g.length; v++) {
          var y = g[v];
          p[y] = d(p[y]);
        }
        ...
        }, l), p.useAsButton && (this._root.button = p.el), p.container.appendChild(this._root.root);
          ...
          palette: R({
            ...
            onchange: function (t, n) {
              if (r.palette) {
                ...
                for (var p, h = o.toHEXA().toString(), v = H(e._swatchColors); !(p = v()).done;) {
                  var d = p.value,
                      g = d.el,
                      y = d.color;
                  g.classList[h === y.toHEXA().toString() ? "add" : "remove"]("pcr-active");
                }
        ...
        var t = this,
          ...
          t._emit("cancel"), t.setHSVA.apply(t, (t._lastColor || t._color).toHSVA().concat([!0]));
        ...
        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            e = this._root,
            r = this.options;
        r.useAsButton || (e.button.style.color = "rgba(0, 0, 0, 0.15)"), e.button.classList.add("clear"), r.showAlways || this.hide(), this._lastColor = null, this._initializingActive || t || (this._emit("save", null), this._emit("clear"));
        ...
        if (r) {
          var n = this._swatchColors,
              o = this._root,
              i = k.apply(void 0, r),
              a = p('<button type="button" style="color: ' + i.toRGBA().toString(0) + '" aria-label="' + this._t("btn:swatch") + '"/>');
        ...
        if (n) {
          ...
          if (c && !c.hidden) for (var u, s = H(a); !(u = s()).done;) {
            var l = u.value;
    ...
    V(W, "utils", n), V(W, "version", "1.8.0"), V(W, "I18N_DEFAULTS", {
