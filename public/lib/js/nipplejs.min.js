!(function (t) {
	...
	var t,
		...
		s = {}
	e
		? (t = { start: 'pointerdown', move: 'pointermove', end: 'pointerup, pointercancel' })
		: n
		? (t = { start: 'MSPointerDown', move: 'MSPointerMove', end: 'MSPointerUp' })
		: i
		? ((t = { start: 'touchstart', move: 'touchmove', end: 'touchend, touchcancel' }), (s = o))
		: (t = o)
	var r = {}
	function d() {}
	function a(t, i) {
	...
	;(r.distance = function (t, i) {
		...
		(r.safeExtend = function (t, i) {
			var e = {}
			for (var n in t)
				t.hasOwnProperty(n) && i.hasOwnProperty(n)
					? (e[n] = i[n])
					: t.hasOwnProperty(n) && (e[n] = t[n])
			return e
		}),
		(r.map = function (t, i) {
			if (t.length) for (var e = 0, n = t.length; e < n; e += 1) i(t[e])
			else i(t)
		}),
		(d.prototype.on = function (t, i) {
			...
			for (var o = 0; o < n.length; o += 1)
				(e = n[o]), (this._handlers_[e] = this._handlers_[e] || []), this._handlers_[e].push(i)
			return this
		}),
		...
		(d.prototype.trigger = function (t, i) {
			...
			for (var s = 0; s < o.length; s += 1)
				(e = o[s]),
					n._handlers_[e] &&
						n._handlers_[e].length &&
						n._handlers_[e].forEach(function (t) {
							t.call(n, { type: e, target: n }, i)
						})
		}),
		...
		(a.prototype.applyStyles = function (t) {
			for (var i in this.ui)
				if (this.ui.hasOwnProperty(i)) for (var e in t[i]) this.ui[i].style[e] = t[i][e]
			return this
		}),
		...
		(a.prototype.restPosition = function (t) {
			var i = this
			i.frontPosition = { x: 0, y: 0 }
			var e = i.options.fadeTime + 'ms',
				n = {}
			n.front = r.getTransitionStyle('transition', ['top', 'left'], e)
			var o = { front: {} }
			;(o.front = { left: i.frontPosition.x + 'px', top: i.frontPosition.y + 'px' }),
				i.applyStyles(n),
				i.applyStyles(o),
		...
		(a.prototype.computeDirection = function (t) {
			...
			if (
				...
				var p = {}
				for (var a in ((this.direction = { x: e, y: n, angle: i }),
		...
		(p.prototype.createNipple = function (t, i) {
			var e = r.getScroll(),
				n = {},
				o = this.options
			if (t.x && t.y) n = { x: t.x - (e.x + this.box.left), y: t.y - (e.y + this.box.top) }
				...
				o.zone.removeChild(s), (n = t), (t = { x: d.left + e.x, y: d.top + e.y })
			}
			var p = new a(this, {
				color: o.color,
				size: o.size,
			...
			return (
				o.dataOnly || (r.applyPosition(p.ui.el, n), r.applyPosition(p.ui.front, p.frontPosition)),
				this.nipples.push(p),
		...
		(p.prototype.processOnMove = function (t) {
			...
			if (!n)
				return (
					console.error('Found zombie joystick with ID ' + e), void this.manager.removeIdentifier(e)
				)
			n.identifier = e
			...
			;((u = n.computeDirection(u)).angle = { radian: r.radians(180 - a), degree: 180 - a }),
				n.trigger('move', u),
				this.trigger('move ' + n.id + ':move', u)
		}),
		(p.prototype.processOnEnd = function (t) {
			...
			o &&
				...
				/(semi|static)/.test(e.mode)
					? i.idles.push(o)
					: i.nipples.indexOf(o) >= 0 && i.nipples.splice(i.nipples.indexOf(o), 1),
		...
		(c.prototype.getIdentifier = function (t) {
			...
			return (
				t
					? void 0 === (i = void 0 === t.identifier ? t.pointerId : t.identifier) &&
					  (i = this.latest || 0)
					: (i = this.index),
