...
!(function (a, b) {
	var c = {
			...
			inherit: function (a, b) {
				for (var c in a)
					b.hasOwnProperty(c) || Object.defineProperty(b, c, Object.getOwnPropertyDescriptor(a, c))
				return b
			},
			...
			storeAPI: {
				...
				namespace: function (a, b) {
					...
					if (
						!(
							(e && e.namespace) ||
							((e = c.Store(this._id, this._area, this._ns + d + '.')), this[d] || (this[d] = e), b)
						)
					)
				...
				isFake: function (a) {
					return (
						a
							? ((this._real = this._area), (this._area = c.storage('fake')))
							: !1 === a && (this._area = this._real || this._area),
				...
				set: function (a, b, d) {
					...
					return null != f && !1 === d
						? b
						: ('boolean' != typeof d && (e = d),
						  c.set(this._area, this._in(a), c.stringify(b, e)) || f)
				},
				setAll: function (a, b) {
					var c, d
