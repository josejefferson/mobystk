...
function updateJoystick(joystick, id, angle, direction) {
	...
	update('right', angle > 292.5 || angle < 67.5); // Pressiona as teclas
...
function resizeJoystick() {
	...
	function inadequateHeight() {
		if (window.outerWidth >= 640) return window.outerHeight < 360; else return window.outerWidth / window.outerHeight > 1.7777777777777778;
