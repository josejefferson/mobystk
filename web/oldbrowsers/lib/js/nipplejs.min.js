!function (t) {
  ...
  function a(t, i) {
    return this.identifier = i.identifier, this.position = i.position, this.frontPosition = i.frontPosition, this.collection = t, this.defaults = {
      ...
      lockX: !1,
      lockY: !1
    }, this.config(i), "dynamic" === this.options.mode && (this.options.restOpacity = 0), this.id = a.id, a.id += 1, this.buildEl().stylize(), this.instance = {
      el: this.ui.el,
  ...
  function p(t, i) {
    return this.nipples = [], this.idles = [], this.actives = [], this.ids = [], this.pressureIntervals = {}, this.manager = t, this.id = p.id, p.id += 1, this.defaults = {
      zone: document.body,
      multitouch: !1,
  ...
  function c(t) {
    var i,
        e = this;
    return e.ids = {}, e.index = 0, e.collections = [], e.config(t), e.prepareCollections(), r.bindEvt(window, "resize", function (t) {
  ...
  r.distance = function (t, i) {
    ...
    return e = r.radians(e), n.x = t.x - i * Math.cos(e), n.y = t.y - i * Math.sin(e), n;
  }, r.radians = function (t) {
    return t * (Math.PI / 180);
  }, r.degrees = function (t) {
    return t * (180 / Math.PI);
  }, r.bindEvt = function (t, i, e) {
    for (var n, o = i.split(/[ ,]+/g), s = 0; s < o.length; s += 1) n = o[s], t.addEventListener ? t.addEventListener(n, e, !1) : t.attachEvent && t.attachEvent(n, e);
  }, r.unbindEvt = function (t, i, e) {
    for (var n, o = i.split(/[ ,]+/g), s = 0; s < o.length; s += 1) n = o[s], t.removeEventListener ? t.removeEventListener(n, e) : t.detachEvent && t.detachEvent(n, e);
    ...
    for (var o in n) if (n.hasOwnProperty(o)) if ("string" == typeof i) n[o] = i + " " + e;else {
      for (var s = "", d = 0, a = i.length; d < a; d += 1) s += i[d] + " " + e + ", ";
    ...
    for (var n in e) e.hasOwnProperty(n) && (e[n] = i);
    ...
    for (var n in t) t.hasOwnProperty(n) && i.hasOwnProperty(n) ? e[n] = i[n] : t.hasOwnProperty(n) && (e[n] = t[n]);

    return e;
  }, r.map = function (t, i) {
    if (t.length) for (var e = 0, n = t.length; e < n; e += 1) i(t[e]);else i(t);
  }, d.prototype.on = function (t, i) {
    var e,
        n = t.split(/[ ,]+/g);
    this._handlers_ = this._handlers_ || {};

    for (var o = 0; o < n.length; o += 1) e = n[o], this._handlers_[e] = this._handlers_[e] || [], this._handlers_[e].push(i);
    ...
    for (var s = 0; s < o.length; s += 1) e = o[s], n._handlers_[e] && n._handlers_[e].length && n._handlers_[e].forEach(function (t) {
      t.call(n, {
        type: e,
        target: n
      }, i);
    ...
    this.options = this.defaults || {}, t && (this.options = r.safeExtend(this.options, t));
  }, d.prototype.bindEvt = function (i, e) {
    var n = this;
    return n._domHandlers_ = n._domHandlers_ || {}, n._domHandlers_[e] = function () {
      "function" == typeof n["on" + e] ? n["on" + e].apply(n, arguments) : console.warn('[WARNING] : Missing "on' + e + '" handler.');
    }, r.bindEvt(i, t[e], n._domHandlers_[e]), s[e] && r.bindEvt(i, s[e], n._domHandlers_[e]), n;
  }, d.prototype.unbindEvt = function (i, e) {
    return this._domHandlers_ = this._domHandlers_ || {}, r.unbindEvt(i, t[e], this._domHandlers_[e]), s[e] && r.unbindEvt(i, s[e], this._domHandlers_[e]), delete this._domHandlers_[e], this;
  }, a.prototype = new d(), a.constructor = a, a.id = 0, a.prototype.buildEl = function (t) {
    ...
    return n.el = {
      ...
      background: this.options.color,
      opacity: ".5"
    }, r.extend(n.el, e), r.extend(n.back, i), r.extend(n.front, i), this.applyStyles(n), this;
    ...
    }, i.options.fadeTime), i.options.restJoystick && i.restPosition(), i);
    ...
    var t = {};
    t.front = r.getTransitionStyle("transition", "none", ""), this.applyStyles(t), this.trigger("rested", this.instance);
    ...
    if (o > s && o < 3 * s && !t.lockX ? i = "up" : o > -s && o <= s && !t.lockY ? i = "left" : o > 3 * -s && o <= -s && !t.lockX ? i = "down" : t.lockY || (i = "right"), t.lockY || (e = o > -r && o < r ? "left" : "right"), t.lockX || (n = o > 0 ? "up" : "down"), t.force > this.options.threshold) {
      var d = {};
      ...
      p.x && p.y || this.trigger("plain", t), p.x || this.trigger("plain:" + e, t), p.y || this.trigger("plain:" + n, t), p.angle || this.trigger("dir dir:" + i, t);
    }

    return t;
  }, p.prototype = new d(), p.constructor = p, p.id = 0, p.prototype.prepareNipples = function () {
    var t = this.nipples;
    t.on = this.on.bind(this), t.off = this.off.bind(this), t.options = this.options, t.destroy = this.destroy.bind(this), t.ids = this.ids, t.id = this.id, t.processOnMove = this.processOnMove.bind(this), t.processOnEnd = this.processOnEnd.bind(this), t.get = function (i) {
      ...
      for (var e = 0, n = t.length; e < n; e += 1) if (t[e].identifier === i) return t[e];
    ...
    if (t.x && t.y) n = {
      ...
      s.style.display = "hidden", s.style.top = t.top, s.style.right = t.right, s.style.bottom = t.bottom, s.style.left = t.left, s.style.position = "absolute", o.zone.appendChild(s);
      var d = s.getBoundingClientRect();
      o.zone.removeChild(s), n = t, t = {
        x: d.left + e.x,
        y: d.top + e.y
      };
    }
    ...
    return o.dataOnly || (r.applyPosition(p.ui.el, n), r.applyPosition(p.ui.front, p.frontPosition)), this.nipples.push(p), this.trigger("added " + p.identifier + ":added", p), this.manager.trigger("added " + p.identifier + ":added", p), this.bindNipple(p), p;
    ...
    var i,
        e = this,
        n = function (t, n) {
      i = t.type + " " + n.id + ":" + t.type, e.trigger(i, n);
    };

    t.on("destroyed", e.onDestroyed.bind(e)), t.on("shown hidden rested dir plain", n), t.on("dir:up dir:right dir:down dir:left", n), t.on("plain:up plain:right plain:down plain:left", n);
    ...
    clearInterval(n.pressureIntervals[e]), n.pressureIntervals[e] = setInterval(function () {
      ...
      e !== o && (i.trigger("pressure", e), n.trigger("pressure " + i.identifier + ":pressure", e), o = e);
    }.bind(n), 100);
  }, p.prototype.onstart = function (t) {
    var i = this,
        e = i.options;
    t = r.prepareEvent(t), i.updateBox();
    ...
    var i,
      ...
      y: t.pageY
        ...
        a = e.getOrCreate(o, d);
    a.identifier !== o && e.manager.removeIdentifier(a.identifier), a.identifier = o;

    var p = function (i) {
      i.trigger("start", i), e.trigger("start " + i.id + ":start", i), i.show(), s > 0 && e.pressureFn(t, i, i.identifier), e.processOnMove(t);
    };

    if ((i = e.idles.indexOf(a)) >= 0 && e.idles.splice(i, 1), e.actives.push(a), e.ids.push(a.identifier), "semi" !== n.mode) p(a);else {
      if (!(r.distance(d, a.position) <= n.catchDistance)) return a.destroy(), void e.processOnStart(t);
      p(a);
    }
    return a;
    ...
    var e,
        n = this.options;
    return /(semi|static)/.test(n.mode) ? (e = this.idles[0]) ? (this.idles.splice(0, 1), e) : "semi" === n.mode ? this.createNipple(i, t) : (console.warn("Coudln't find the needed nipple."), !1) : e = this.createNipple(i, t);
  }, p.prototype.processOnMove = function (t) {
    var i = this.options,
        e = this.manager.getIdentifier(t),
        n = this.nipples.get(e);
    if (!n) return console.error("Found zombie joystick with ID " + e), void this.manager.removeIdentifier(e);
    n.identifier = e;
    var o = n.options.size / 2,
      ...
      y: t.pageY
        ...
        p = r.radians(a),
        c = d / o;
    d > o && (d = o, s = r.findCoord(n.position, d, a));
    var h = s.x - n.position.x,
        l = s.y - n.position.y;
    i.lockX && (l = 0), i.lockY && (h = 0), n.frontPosition = {
      x: h,
      y: l
    ...
    (u = n.computeDirection(u)).angle = {
      radian: r.radians(180 - a),
      degree: 180 - a
    }, n.trigger("move", u), this.trigger("move " + n.id + ":move", u);
    ...
    }), clearInterval(i.pressureIntervals[o.identifier]), o.resetDirection(), o.trigger("end", o), i.trigger("end " + o.id + ":end", o), i.ids.indexOf(o.identifier) >= 0 && i.ids.splice(i.ids.indexOf(o.identifier), 1), i.actives.indexOf(o) >= 0 && i.actives.splice(i.actives.indexOf(o), 1), /(semi|static)/.test(e.mode) ? i.idles.push(o) : i.nipples.indexOf(o) >= 0 && i.nipples.splice(i.nipples.indexOf(o), 1), i.manager.unbindDocument(), /(semi|static)/.test(e.mode) && (i.manager.ids[s.id] = s.identifier));
  ...
  }, c.prototype = new d(), c.constructor = c, c.prototype.prepareCollections = function () {
    var t = this;
    ...
    return this.onAny("end", t), !1;
  }, c.prototype.onAny = function (t, i) {
    var e,
        n = this,
        o = "processOn" + t.charAt(0).toUpperCase() + t.slice(1);
    i = r.prepareEvent(i);
    return r.map(i, function (t) {
      e = n.getIdentifier(t), r.map(n.collections, function (t, i, e) {
        e.ids.indexOf(i) >= 0 && (e[o](t), t._found_ = !0);
      }.bind(null, t, e)), t._found_ || n.removeIdentifier(e);
    }), !1;
  }, c.prototype.destroy = function () {
    this.unbindDocument(!0), this.ids = {}, this.index = 0, this.collections.forEach(function (t) {
      t.destroy();
    }), this.off();
  }, c.prototype.onDestroyed = function (t, i) {
